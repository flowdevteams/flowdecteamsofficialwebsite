        ...
        <div className="inverse-panel relative w-full overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 px-4 py-10 text-center sm:px-8 sm:py-12 lg:px-14 lg:py-20 bg-[#142d52]">
          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            <AnimatedSection animation="fade-in-down">
              <span className="inline-flex items-center px-3 sm:px-4 py-1.5 rounded-full text-xs sm:text-xs font-semibold uppercase tracking-wider bg-white/10 text-white mb-4 sm:mb-6 border border-white/20">
            ...
            <AnimatedSection animation="fade-in-up" delay={200}>
              <p className="text-sm sm:text-base lg:text-lg text-white/85 leading-relaxed text-pretty">
            ...
            {/* Micro Trust Pills */}
            <AnimatedSection animation="fade-in-up" delay={300} className="mt-6 sm:mt-8 grid grid-cols-3 sm:flex sm:flex-wrap items-center justify-center gap-1.5 sm:gap-3 lg:gap-6 text-[10.5px] sm:text-xs lg:text-sm text-white/90">
